...
4. Task 34 retention preview is COMPLETE on PR #92 pending final integration. Task 37 restore-execution review is active independently on PR #93. Task 39 adapter-contract refactor is prerequisite-safe because Task 38 is now merged on main.
...
8. Task 34 depends on Task 30 and that dependency is satisfied by merge `99d081cd242642bfa8346031a22079b7397869bc`. Task 34 is implemented read-only on PR #92; actual pruning/deletion remains deferred pending a later execute-boundary review.
...
13. Task 39 depends on Task 38; that dependency is now satisfied by PR #91 merge `11b9a4d4e508ac93cd436037563c09d08cfa43ab`. It remains the bounded adapter-contract refactor.
14. Public release/tagging requires explicit user authorization and an exact green candidate; private-host proof limitation must remain explicit until actually proven.
