...
3. Tasks 16, 17, 18, 20, 21, 22, 23, 24 and 25 are complete on main; do not duplicate them.
4. Tasks 26–29 are the current bounded public queue after ownership reconciliation: bounded service journal/log access review, database restore/recovery boundary review, deployment/rollback completion-delivery integration, and privacy-safe guided connectivity reconciliation.
