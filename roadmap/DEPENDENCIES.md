...
3. Tasks 16, 17, 18, 20, 21, 22, 23, 24, 25, 26 and 27 are complete on main; do not duplicate them.
4. Tasks 28–31 are the current bounded public queue after ownership reconciliation: deployment/rollback completion-delivery integration, privacy-safe guided connectivity reconciliation, automated retention-pruning boundary review, and local read-only database restore preflight.
