...
4. Task 33 graphical-administration review, Task 35 historical-rollback review, and Task 38 adapter-boundary review are complete on open PR #91 pending integration; do not duplicate them. Task 34 retention preview and Task 37 restore-execution boundary review remain prerequisite-safe independent work.
...
13. Task 39 depends on acceptance/integration of Task 38 and is the bounded adapter-contract refactor; do not start it from stale main while PR #91 remains open.
