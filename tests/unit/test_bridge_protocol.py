...
@pytest.mark.parametrize(
    ...
    [
        ...
        '{"request_id":"req-001","action":"worker_status","job_id":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"}',
        '{"request_id":"req-001","action":"job_status"}',
        '{"request_id":"req-001","action":"cancel_job","project":"demo","job_id":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"}',
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        '{"request_id":"req-001","action":"job_status","job_id":"../../unsafe"}',
        '{"request_id":"req-001","action":"cancel_job","job_id":"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"}',
    ],
)
